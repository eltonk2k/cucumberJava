...
public class DefinicaoPassosComArgumentos {
    ...
    @DataTableType
    public Livro definicaoLivro(Map<String, String> entrada) {//trim retirar os espacos em branco
        return new Livro(
                entrada.get("titulo"),
    ...
    @E("a seguinte tabela de livros:")//Outra forma de converter a lista pra strings seria List<String> livros)
